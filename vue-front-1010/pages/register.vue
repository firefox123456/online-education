  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle no-radius" prop="qqmail" :rules="[{ required: true, message: '请输入qq邮箱账号', trigger: 'blur' },{validator: checkPhone, trigger: 'blur'}]">
          <div>
            <el-input type="text" placeholder="qq邮箱账号" v-model="params.qqmail"/>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //发送验证码
      getCodeFun(){
        registerApi.sendCode(this.params.qqmail).then(response=>{
            this.sending = false
            //调用倒计时的方法
            this.timeDown()
        })
